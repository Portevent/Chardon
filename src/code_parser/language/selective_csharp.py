...
from src.code_parser.language.csharp import Block, _parse_block, _clean_line
from src.code_parser.language.parser import Parser, ParsingError
from src.code_parser.structure.class_ import Class
from src.code_parser.structure.field import Field


# pylint: disable=too-few-public-methods
class SelectiveCSharpParser(Parser):
    """
    C# Parser to extract Class and Functions from a File
    Note : this is a selective language, it will only parse documented code
    """
